...
if ($accion == 'Salir') {
    session_destroy();
    echo '<script>window.location.replace("/Volkwik2020/views");</script>';
};
        ...
        <div class="menu">
            <nav>
                ...
                <ul>
                    ...
                    <li><input class="buscador  menu-selected " placeholder="Buscador" hidden></li>
                    <li><a href="/Volkwik2020/views/vistasE/admin.php" class="menu-selected right"><b>Mantenimientos</b></a></li>
                    <li>
                        ...
                        <div id="bar">
                            <div id="container">
                                ...
                                <div id="loginContainer">
                                    <a href="#" id="loginButton">  <button style="border: none">
                                            <?php
                                        ...
                                        <div id="loginBox">                
                                            <form action="" method="POST">
                                                <fieldset class="tag">
                                                    <fieldset>
                                                        <img class="img-thumbnail" src="./vistasE/FotosEmp/<?php echo $lempleado['Foto']; ?>" width="100" height="100" alt="<?php echo $lempleado['Nombres']; ?>"/>
                                                        <br><a class="dropdown-item" style="font-size: 20px" href="vistasE/admin.php" >Mis Mantenimientos</a><br>
                                                        <a class="dropdown-item" style="font-size: 16px"><?php echo $lempleado['User']; ?></a><br>
                                                        <a class="dropdown-item" style="font-size: 16px"><?php echo $lempleado['Correo']; ?></a><br><br>
                                                    <?php } ?>
